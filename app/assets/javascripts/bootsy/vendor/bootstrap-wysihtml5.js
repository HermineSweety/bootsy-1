!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn btn-secondary " + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='fa fa-align-left'></i></a>" +
                "<a class='btn btn-secondary " + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='fa fa-align-right'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn btn-secondary " + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='fa fa-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
